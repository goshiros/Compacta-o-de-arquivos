...
procura a casa com a menor das frequências e troca todo o conteúdo dessa casa
...
int main (){
  ...
  int binario[256][50], caminho [50], altura = 0, direcao = -1; /* função monta_matriz */
  ...
  if (comando == 1){
    ...
    a soma das frequências eh inserida no vetor. Os ponteiros *esq e *dir apontam
    ...
    printf ("Verifique o arquivo de saída para visualizar o arquivo compactado.\n");
  ...
  if (comando == 2){
    ...
    caracteres e suas respectivas frequências. Vamos ler a arvore e remontar
